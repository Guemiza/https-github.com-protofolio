              ...
              <div class="col-4">
                <div class="swiper-slide">
                  <div class="subscribe-plan position-relative bg-white d-flex flex-column align-items-center rounded-sm shadow pt-50 pb-20 px-20">
                    ...
                    <button class="badge badge-popular px-15 py-5"><span style="color:white" ><?php echo e(trans('panel.popular')); ?></span></button>
                    <?php endif; ?>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dali\Music\Abajim 3\Abajimnew\Abajim\resources\views/web/default/pages/home.blade.php ENDPATH**/ ?>