            ...
            <div class="table-responsive text-center">
                <table class="table table-striped font-14">
                    <tr>
                        ...
                        <th><?php echo e(trans('admin/main.parent')); ?></th>
                        <th><?php echo e(trans('admin/main.mobile_parent')); ?></th>
                        <th><?php echo e(trans('admin/main.level')); ?></th>
                        <th><?php echo e(trans('admin/main.subscribe')); ?></th>
                    ...
                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr>
                            ...
                            <td class="text-left">
                             ...
                             <?php  $varff = DB::table('users')->where('id', $user->organ_id)->pluck('full_name');
                                    $mobile = DB::table('users')->where('id', $user->organ_id)->pluck('mobile'); 
                                    $level = DB::table('school_levels')->where('id', $user->level_id)->pluck('name');                       
                                    $package_sales = DB::table('order_items')->where('user_id', $user->id)->pluck('subscribe_id');                       

                                ?>
                            <td><?php if(!empty($varff[0])): ?><?php echo e($varff[0]); ?><?php endif; ?></td>
                            <td><?php if(!empty($mobile[0])): ?><?php echo e($mobile[0]); ?><?php endif; ?></td>

                           <td><?php if(!empty($level[0])): ?><?php echo e($level[0]); ?><?php endif; ?></td>
                           <td> <?php if(!empty($package_sales[0])): ?>
                                    <?php                       
                                    $subscribe = DB::table('subscribe_translations')->where('subscribe_id', $package_sales[0])->where('locale', 'ar')->pluck('title');                       
                                    ?>
                                    <?php if(!empty($subscribe[0])): ?><?php echo e($subscribe[0]); ?><?php endif; ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\moham\OneDrive\Desktop\Abajim\Abajimnew21052024\Abajimnew\Abajim\resources\views/admin/school/list_kids.blade.php ENDPATH**/ ?>