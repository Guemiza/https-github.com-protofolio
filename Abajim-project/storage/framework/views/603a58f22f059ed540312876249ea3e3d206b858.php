...
#navbar22 {
    overflow-x: auto;
    white-space: nowrap;
    width: 94%; /* ensure your scrollable element has a defined width */
    margin-left: 10px;
}
.nav-pills {
...
.scrollmenu::-webkit-scrollbar { /* Chrome, Safari and Opera */
  display: none;
}
...
p.ytcp-paper-tooltip-body,ytcp-paper-tooltip-body > p  { 
    margin: 1em 0;
} 

p.ytcp-paper-tooltip-body:first-of-type,ytcp-paper-tooltip-body > p:first-of-type  { 
    margin-top: 0;
} 

p.ytcp-paper-tooltip-body:last-of-type,ytcp-paper-tooltip-body > p:last-of-type  { 
    margin-bottom: 0;
} 
 ...
 <ul class="nav nav-pills scrollmenu">
     <div class="scrollmenu">
             ...
             <?php $__currentLoopData = $Manuels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $manuel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                 <li class="nav-item ">
                     <a class="nav-link <?php echo e($manuel->id ==  $id  ? 'active' : ''); ?>" href="/panel/scolaire/teacher/<?php echo e($manuel->id); ?>icon=1&page=6"><?php echo e($manuel->matiere->section->level->name); ?> <?php echo e($manuel->matiere->section->name); ?> </a>
                 </li>
...
<img src="/assets/default/img/arrow-right.png" id="scroll-right" style="position: absolute;right: 19px; margin-top: -41px; cursor:pointer!important;" />
  ...
  <object data="<?php echo e(asset($pdfPath)); ?>#page=6" type="application/pdf" width="100%" height="880px"  >
    ...
    <tp-yt-paper-tabs class="style-scope ytcp-primary-action-bar" scrollable="" role="tablist" tabindex="0">
      ...
      <div id="tabsContainer" class="style-scope tp-yt-paper-tabs style-iYFIZ">
        <div id="tabsContent" style-target="content" class="tabs-content scrollable style-scope tp-yt-paper-tabs">
          ...
          <tp-yt-paper-tab slot="tabs" noboldonfocus="" class="style-scope yta-screen " id="content" role="tab" style-target="host" aria-disabled="false" tabindex="-1" aria-selected="false">
            <div class="tab-content style-scope tp-yt-paper-tab" style-target="tab-content">
              <ytcp-ve track-click="" class=" style-scope yta-screen style-scope yta-screen" role="none">
                <a href="/panel/scolaire/teacher/159">My chaine</a>
              </ytcp-ve>
            </div>
          ...
          <tp-yt-paper-tab slot="tabs" noboldonfocus="" class="style-scope yta-screen" id="overview" role="tab" style-target="host" aria-disabled="false" aria-selected="true" tabindex="0" focused="">
            <div class="tab-content style-scope tp-yt-paper-tab" style-target="tab-content">
              <ytcp-ve track-click="" class=" style-scope yta-screen style-scope yta-screen" role="none">
              <a  href="/panel/scolaire/teacher/<?php echo e($id); ?>?icon=1&page=6">  Dashboard</a>
              </ytcp-ve>
            </div>
            <paper-ripple class="style-scope tp-yt-paper-tab">
...
<div class="container">
       <div class="row login-container">
           <div class="col-12 col-md-5 pl-0">
               <img src="/Video-Marketing.png" class="img-cover" alt="Login">
           </div>
           <div class="col-12 col-md-7">
               <div class="login-card">
                   <h1 class="font-20 font-weight-bold">Add your Video</h1>

                   <form action="<?php echo e(route('add.videos')); ?>" method="POST" enctype="multipart/form-data">
                   <?php echo csrf_field(); ?>
   <?php
...
?>
                 ...
                 <br><br>
                       <div class="form-group">
                           <label class="input-label" for="titre">Titre:</label>
                           <input name="titre" type="text" value="<?php echo e(old('titre')); ?>" class="form-control <?php $__errorArgs = ['titre'];
...
unset($__errorArgs, $__bag); ?>
                       ...
                       <input type="hidden" placeholder="enter manuel id" name="manuel" value="<?php echo e($parameterValue); ?>" onclick="this.value=''">
      
      <input type="hidden"  name="numero" value="<?php echo e($icon); ?>" onclick="this.value=''">
    
      <input type="hidden"  name="page" value="<?php echo e($page); ?>" onclick="this.value=''">
      <div class="form-group ">
...
unset($__errorArgs, $__bag); ?>" name="video"  id="video" class="box">
...
unset($__errorArgs, $__bag); ?>
                       ...
                       <div class="form-group ">
                           <label class="input-label" for="thumbnail">Image video:</label>
...
unset($__errorArgs, $__bag); ?>"  name="thumbnail" accept="image/jpeg,image/png">
...
unset($__errorArgs, $__bag); ?>
                       ...
                       <div class="form-group">
                           ...
                           <input name="description" placeholder="enter your description" required maxlength="1000" cols="50" rows="50"
...
unset($__errorArgs, $__bag); ?>
                       ...
                       <button type="submit"
                               class="btn btn-primary btn-block mt-20">Add Video</button>
                   </form>
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\moham\OneDrive\Desktop\Abajim\Abajimnew21052024\Abajimnew\Abajim\resources\views/web/default/panel/manuel_scolaire/listviewteacher.blade.php ENDPATH**/ ?>