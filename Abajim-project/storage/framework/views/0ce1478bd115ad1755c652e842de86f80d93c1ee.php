        ...
        <?php if($authUser->isSchool()): ?>
            <div class="row">
                <div class="col-lg-6 col-md-4 col-sm-12">
                        <?php if(!empty($getTotalSalesStatisticsSchool)): ?>
                            <div class="card card-statistic-2">
                                <div class="card-stats">
                                    ...
                                    <div class="card-stats-items">
                                        <div class="card-stats-item">
                                            <div class="card-stats-item-count"><?php echo e($getTotalSalesStatisticsSchool['todaySales']); ?></div>
                                            <div class="card-stats-item-label"><?php echo e(trans('admin/main.today')); ?></div>
                                        </div>
                                        <div class="card-stats-item">
                                            <div class="card-stats-item-count"><?php echo e($getTotalSalesStatisticsSchool['monthSales']); ?></div>
                                            <div class="card-stats-item-label"><?php echo e(trans('admin/main.this_month')); ?></div>
                                        </div>
                                        <div class="card-stats-item">
                                            <div class="card-stats-item-count"><?php echo e($getTotalSalesStatisticsSchool['yearSales']); ?></div>
                                ...
                                <div class="card-wrap">
                                    ...
                                    <div class="card-body">
                                        <?php echo e($getTotalSalesStatisticsSchool['totalSales']); ?>
                ...
                <div class="col-lg-6 col-md-4 col-sm-12">              
                        <?php if(!empty($getIncomeStatisticsSchool)): ?>
                            <div class="card card-statistic-2">
                                <div class="card-stats">
                                    <div class="card-stats-title"><?php echo e(trans('admin/main.income_statistics_school')); ?></div>

                                    <div class="card-stats-items">
                                        <div class="card-stats-item">
                                            <div class="card-stats-item-count"><?php echo e(addCurrencyToPrice($getIncomeStatisticsSchool['todaySales'])); ?></div>
                                            <div class="card-stats-item-label"><?php echo e(trans('admin/main.today')); ?></div>
                                        </div>

                                        <div class="card-stats-item">
                                            <div class="card-stats-item-count"><?php echo e(addCurrencyToPrice($getIncomeStatisticsSchool['monthSales'])); ?></div>
                                            <div class="card-stats-item-label"><?php echo e(trans('admin/main.this_month')); ?></div>
                                        </div>

                                        <div class="card-stats-item">
                                            <div class="card-stats-item-count"><?php echo e(addCurrencyToPrice($getIncomeStatisticsSchool['yearSales'])); ?></div>
                                            <div class="card-stats-item-label"><?php echo e(trans('admin/main.this_year')); ?></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-wrap">
                                    ...
                                    <div class="card-body">
                                        <?php echo e(addCurrencyToPrice($getIncomeStatisticsSchool['totalSales'])); ?>
              ...
              <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <a href="/admin/financial/sales" class="card card-statistic-1">
                            ...
                            <div class="card-wrap">
                                ...
                                <div class="card-body">
                                    <?php echo e($getNewSalesCountSchool); ?>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <a class="card card-statistic-1">
                            ...
                            <div class="card-wrap">
                                <div class="card-header">
                                    <h4><?php echo e(trans('admin/main.list_of_participating_children')); ?></h4>
                                </div>
                                <div class="card-body">
                                    <?php echo e($getSubscribeCountSchool); ?>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <a href="/admin/comments/webinars" class="card card-statistic-1">
                            ...
                            <div class="card-wrap">
                                <div class="card-header">
                                    <h4><?php echo e(trans('admin/main.list_of_not_participating_children')); ?></h4>
                                </div>
                                <div class="card-body">
                                    <?php echo e($getNotSubscribeCountSchool); ?>
           ...
           <?php if(!$authUser->isSchool()): ?>
                    ...
                    <div class="col-lg-8 col-md-12 col-12 col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <?php if(!empty($getMonthAndYearSalesChartStatisticsSchool)): ?>
                                            <div class="statistic-details mt-4 position-relative">
                                                <div class="statistic-details-item">
                                                    <span class="text-muted">
                                                        <?php if($getMonthAndYearSalesChartStatisticsSchool['todaySales']['grow_percent']['status'] == 'up'): ?>
                                                            <span class="text-primary"><i class="fas fa-caret-up"></i></span>
                                                        <?php else: ?>
                                                            <span class="text-danger"><i class="fas fa-caret-down"></i></span>
                                                        <?php endif; ?>

                                                        <?php echo e($getMonthAndYearSalesChartStatisticsSchool['todaySales']['grow_percent']['percent']); ?>

                                                    </span>

                                                    <div class="detail-value"><?php echo e(addCurrencyToPrice($getMonthAndYearSalesChartStatisticsSchool['todaySales']['amount'])); ?></div>
                                                    <div class="detail-name"><?php echo e(trans('admin/main.today_sales')); ?></div>
                                                </div>
                                                <div class="statistic-details-item">
                                                    <span class="text-muted">
                                                        <?php if($getMonthAndYearSalesChartStatisticsSchool['weekSales']['grow_percent']['status'] == 'up'): ?>
                                                            <span class="text-primary"><i class="fas fa-caret-up"></i></span>
                                                        <?php else: ?>
                                                            <span class="text-danger"><i class="fas fa-caret-down"></i></span>
                                                        <?php endif; ?>

                                                        <?php echo e($getMonthAndYearSalesChartStatisticsSchool['weekSales']['grow_percent']['percent']); ?>

                                                    </span>

                                                    <div class="detail-value"><?php echo e(addCurrencyToPrice($getMonthAndYearSalesChartStatisticsSchool['weekSales']['amount'])); ?></div>
                                                    <div class="detail-name"><?php echo e(trans('admin/main.week_sales')); ?></div>
                                                </div>
                                                <div class="statistic-details-item">
                                                    <span class="text-muted">
                                                        <?php if($getMonthAndYearSalesChartStatisticsSchool['monthSales']['grow_percent']['status'] == 'up'): ?>
                                                            <span class="text-primary"><i class="fas fa-caret-up"></i></span>
                                                        <?php else: ?>
                                                            <span class="text-danger"><i class="fas fa-caret-down"></i></span>
                                                        <?php endif; ?>

                                                        <?php echo e($getMonthAndYearSalesChartStatisticsSchool['monthSales']['grow_percent']['percent']); ?>

                                                    </span>

                                                    <div class="detail-value"><?php echo e(addCurrencyToPrice($getMonthAndYearSalesChartStatisticsSchool['monthSales']['amount'])); ?></div>
                                                    <div class="detail-name"><?php echo e(trans('admin/main.month_sales')); ?></div>
                                                </div>
                                                <div class="statistic-details-item">
                                                    <span class="text-muted">
                                                        <?php if($getMonthAndYearSalesChartStatisticsSchool['yearSales']['grow_percent']['status'] == 'up'): ?>
                                                            <span class="text-primary"><i class="fas fa-caret-up"></i></span>
                                                        <?php else: ?>
                                                            <span class="text-danger"><i class="fas fa-caret-down"></i></span>
                                                        <?php endif; ?>

                                                        <?php echo e($getMonthAndYearSalesChartStatisticsSchool['yearSales']['grow_percent']['percent']); ?>

                                                    </span>

                                                    <div class="detail-value"><?php echo e(addCurrencyToPrice($getMonthAndYearSalesChartStatisticsSchool['yearSales']['amount'])); ?></div>
                                                    <div class="detail-name"><?php echo e(trans('admin/main.year_sales')); ?></div>
                                                </div>
                                            </div>
                                        <?php endif; ?>
            ...
            <?php if($authUser->isSchool()): ?>
             <div class="col-lg-4 col-md-12 col-12 col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4><?php echo e(trans('admin/main.classes_statistics_level')); ?></h4>
                    </div>
                    <div class="card-body">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\moham\OneDrive\Desktop\Abajim\Abajimnew21052024\Abajimnew\Abajim\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>