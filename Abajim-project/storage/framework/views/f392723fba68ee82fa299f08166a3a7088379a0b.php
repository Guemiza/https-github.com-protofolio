                ...
                <?php if($heroSection == "2"): ?>
                    <div class="row slider-content align-items-center hero-section2 flex-column-reverse flex-md-row">
                        <div class="col-12 col-md-7 col-lg-6">
                            ...
                            <p style="font-size: 21px;" class=" text-black mt-20"><?php echo nl2br($heroSectionData['description']); ?></p>
...
<!-- <img      style="margin-left: 406px; width: 1020px;height: 473px;" src="./assets/brannd.png"/> -->
                            ...
                            <?php $__currentLoopData = $subscribes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subscribe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-4">
                                    ...
                                    <div class="subscribe-plan position-relative bg-white d-flex flex-column align-items-center rounded-sm shadow pt-50 pb-20 px-20">
                                        ...
                                        <button class="badge badge-popular px-15 py-5" style="    background: #1d3b65;" ><span style="color:white" ><?php echo e(trans('panel.popular')); ?></span></button>
                                        <?php endif; ?>
                                        ...
                                        <a style="color:white" href="/login" ><?php echo e(trans('financial.purchase')); ?></a>
                                        </button>
                                        <?php endif; ?>
                                    </div>
                                    </div>
        ...
        <?php if($homeSection->name == \App\Models\HomeSection::$instructors and !empty($instructors) and !$instructors->isEmpty()): ?>
            <section class="home-sections container">
                <div class="d-flex justify-content-between">
                    <div>
                        <h2 class="section-title"><?php echo e(trans('home.homeinstructors')); ?></h2>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\moham\OneDrive\Desktop\Abajim\Abajimnew21052024\Abajimnew\Abajim\resources\views/web/default/pages/home.blade.php ENDPATH**/ ?>