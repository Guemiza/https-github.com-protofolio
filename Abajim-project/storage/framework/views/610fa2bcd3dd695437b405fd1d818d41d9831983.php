...
<div id="panel_app" >
    <div style="z-index:9999999999999999!important">
        <?php echo $__env->make(getTemplate().'.includes.navbarPannelEnfant', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
    <div class="d-flex justify-content-end"  >
        <?php echo $__env->make(getTemplate(). '.panel.includes.sidebarEnfant', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script>
        (function () {
            ...
            $.toast({
                ...
                bgColor: '<?php if(session()->get('toast')['status'] == 'success'): ?> #1d3b65 <?php else: ?> #f63c3c <?php endif; ?>',
                textColor: 'white',
                hideAfter: 10000,
...
<?php /**PATH C:\Users\moham\OneDrive\Desktop\Abajim\Abajimnew21052024\Abajimnew\Abajim\resources\views/web/default/panel/layouts/panel_layoutEnfant.blade.php ENDPATH**/ ?>