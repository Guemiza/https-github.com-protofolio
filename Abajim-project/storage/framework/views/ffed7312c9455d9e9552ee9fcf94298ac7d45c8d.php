    ...
    <div class="mt-45">
        <?php if($course->reviews->count() > 0 ): ?>
            <?php $__currentLoopData = $course->reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  
             <?php if(!empty($review->creator)): ?>      <!-- i add this in 26-09-2023 -->
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="user-inline-avatar d-flex align-items-center mt-10">
                            <div class="avatar bg-gray200">
                                <img src="if<?php echo e($review->creator->getAvatar()); ?>" class="img-cover" alt="">
                            </div>
...
<?php /**PATH C:\Users\moham\OneDrive\Desktop\Abajim\Abajimnew21052024\Abajimnew\Abajim\resources\views/web/default/course/tabs/reviews.blade.php ENDPATH**/ ?>