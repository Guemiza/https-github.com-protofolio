    ...
    <aside id="sidebar-wrapper">
       <?php if($authUser->isSchool()): ?>
        <div class="sidebar-brand">
                <img src="/store/1/abajim.png" style="width: 48%;height: 70%!important;" class="img-cover mt-10" alt="site logo">
        </div>
       <?php else: ?>
        <div class="sidebar-brand">
            <a href="/">
       ...
       <?php endif; ?>
        ...
        <ul class="sidebar-menu">
            ...
            <?php endif; ?>
            <?php if($authUser->isSchool()): ?>
               <li class="nav-item <?php echo e((request()->is('admin/school/create/kids*')) ? 'active' : ''); ?>" >
                    <a href="/admin/school/create/kids" class="nav-link beep beep-sidebar" >
                        <i class="fa fa-user-plus "></i>
                        <span><?php echo e(trans('public.school_kids_add')); ?></span>
                    </a>
                </li>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_users')): ?>
             <?php if($authUser->isSchool()): ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_users_list')): ?>
                            <li class="<?php echo e((request()->is('admin/school/kids')) ? 'active' : ''); ?>">  
                                <a class="nav-link" href="/admin/school/kids">
                                    <i class="fa fa-users"></i>
                                    <span><?php echo e(trans('public.school_kids_list')); ?></span>
                                </a>
                            </li>
                        <?php endif; ?>
             <?php else: ?>            
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_users_list')): ?>
                            <li class="<?php echo e((request()->is('admin/students')) ? 'active' : ''); ?>">
                                <a class="nav-link" href="/admin/students"><?php echo e(trans('public.school_kids_list')); ?></a>
                            </li>
                        <?php endif; ?>
                        <?php endif; ?>  
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_organizations_list')): ?>
                            <li class="<?php echo e((request()->is('admin/organizations')) ? 'active' : ''); ?>">
                                <a class="nav-link" href="/admin/organizations"><?php echo e(trans('public.parent_list')); ?></a>
                            </li>
                        <?php endif; ?>
                        <?php if($authUser->isAdmin()): ?>
                    ...
                    <ul class="dropdown-menu">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_supports_list')): ?>
                            <li class="<?php echo e((request()->is('admin/supports')) ? 'active' : ''); ?>">
                                <a class="nav-link" href="/admin/supports"><?php echo e(trans('admin/main.tickets')); ?></a>
                            </li>
                        <?php endif; ?>
            ...
            <?php if($authUser->isSchool()): ?>
                  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_subscribe_list')): ?>
                            <li class="<?php echo e((request()->is('admin/financial/subscribes')) ? 'active' : ''); ?>">
                                <a class="nav-link" href="/admin/financial/subscribes">
...
<?php /**PATH C:\Users\moham\OneDrive\Desktop\Abajim\Abajimnew21052024\Abajimnew\Abajim\resources\views/admin/includes/sidebar.blade.php ENDPATH**/ ?>