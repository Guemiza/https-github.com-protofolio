...
<div class="panel-sidebar pt-50 pb-25 px-25" style="z-index:9!important" id="panelSidebar">
    ...
    <div class="user-info d-flex align-items-center flex-row flex-lg-column justify-content-lg-center">
        ...
        <div class="d-flex flex-column align-items-center justify-content-center">
            ...
            <?php if(!empty($matiereNames)): ?>

            <p class="font-13">
                <?php if(count($matiereNames) == 1): ?>
                مادة : <?php echo e($matiereNames[0]); ?>

                <?php elseif(count($matiereNames) == 2): ?>
                مادتين: <?php echo e($matiereNames[0]); ?> و <?php echo e($matiereNames[1]); ?>

                <?php else: ?>
                المواد :
                <?php $__currentLoopData = $matiereNames; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php echo e($name); ?>

                <?php if($key < count($matiereNames) - 1): ?> و <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> <?php endif; ?> </p>
        ...
        <div style="margin-top:15px">
            ...
            <form action="/locale" method="post" class="mr-15 mx-md-20">
                ...
                <div class="language-select1">
                    <div id="localItems" data-selected-country="<?php echo e(localeToCountryCode(mb_strtoupper(app()->getLocale()))); ?>" data-countries='<?php echo e(json_encode($localLanguage)); ?>'></div>
                </div>
            </form>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\Users\moham\OneDrive\Desktop\Abajim\Abajimnew21052024\Abajimnew\Abajim\resources\views/web/default/panel/includes/sidebar.blade.php ENDPATH**/ ?>