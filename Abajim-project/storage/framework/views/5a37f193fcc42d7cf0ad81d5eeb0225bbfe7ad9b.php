...
<div class="row">
    <div class="col-sm-7">
        ...
        <div style="padding:10px">
            <object data="<?php echo e(asset($pdfPath)); ?>#toolbar=0&page=<?php echo e($page); ?>&zoom=auto" type="application/pdf" width="100%"
                height="880px">
                <p>Unable to display PDF file. <a href="<?php echo e($pdfPath); ?>">Download</a> instead.</p>
            </object>
        </div>
    </div>
    <div class="col-lg-5  d-none d-sm-block" style="height:883px">

        <div>

            <div  class="form-inline my-2 my-lg-0 navbar-search position-relative " style="margin-top: 4px !important;" >

                <input style="width:243px" class="form-control mr-5 rounded" type="text" name="search"
                ...
                <div>
                    ...
                    <select name="sort" class="form-control">
                        ...
                        <option value="top_rate" <?php if(request()->get('sort', null) == 'top_rate'): ?> selected="selected"
                            <?php endif; ?>>
                            <?php echo e(trans('site.top_rate')); ?>

                        </option>
                        <option value="top_sale" <?php if(request()->get('sort', null) == 'top_sale'): ?> selected="selected"
                            <?php endif; ?>>Top Vus
                        </option>
                    </select>
                </div>
            ...
            <?php if(!empty($videostitleAll)): ?>
                ...
                <h2 style="margin-top:30px"> <span class="gradient-title" style="padding: 54px!important;text-align: center;background: linear-gradient(to left,#1d3b65,#22bec8);-webkit-background-clip: text;color: transparent;" ><?php echo e($videostitleAll->titleAll); ?></span></h2>
                <br>
            <?php endif; ?>
            <?php if($videos != '[]'): ?>
                                        ...
                                        <div class="col-2">
                                            <a class="yt-simple-endpoint style-scope ytd-video-owner-renderer  ml-16"
                                                ...
                                                <yt-img-shadow id="avatar" width="40"
                                                    ...
                                                    <img id="img" class="style-scope yt-img-shadow " width="40"
                                                        src="<?php echo e($videos[0]->teachers->avatar); ?>">
            ...
            <div class="scrollable-div" style="margin-top:10px" id="scrollable-div">
                <?php $__currentLoopData = $videos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="webinar-card webinar-list webinar-list-2 d-flex m-10">
                        <div class="image-box" style="min-width: 59%;margin-top: -88px!important"
                        ...
                        <div class="webinar-card-body w-100 d-flex flex-column">
                            <div class="d-flex align-items-center justify-content-between">
                                <a
                                    ...
                                    <h4 class="mt-5 webinar-title font-weight-bold font-12 text-dark-blue"
                                        style="white-space: normal;font-size: 0.895rem !important;"> <?php echo e($video->titre); ?> </h4>
                                </a>
                            </div>
                            <div class="user-inline-avatar d-flex align-items-center">
                                <div class="avatar bg-gray100">
                                    <img src="<?php echo e($video->teachers->avatar); ?>" class="img-cover"
                                        alt="">
                                </div>
                            ...
                            <?php echo $__env->make('web.default.includes.webinar.rate',['rate' => 4], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make(getTemplate() . '.panel.layouts.panel_layoutEnfant', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dali\Music\Abajim 3\Abajimnew\Abajim\resources\views/web/default/panel/manuel_scolaire/lisr_free_parser.blade.php ENDPATH**/ ?>