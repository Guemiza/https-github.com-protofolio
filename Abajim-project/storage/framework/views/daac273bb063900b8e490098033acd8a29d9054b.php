                ...
                <div class="row">
                    <div class="col-12 col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            <select name="ajax[<?php echo e(!empty($file) ? $file->id : 'new'); ?>][locale]" class="form-control <?php echo e(!empty($file) ? 'js-webinar-content-locale' : ''); ?>" data-webinar-id="<?php echo e(!empty($webinar) ? $webinar->id : ''); ?>" data-id="<?php echo e(!empty($file) ? $file->id : ''); ?>" data-relation="files" data-fields="title,description">
                        ...
                        <div class="form-group">
                            ...
                            <select name="ajax[<?php echo e(!empty($file) ? $file->id : 'new'); ?>][storage]" class="js-file-storage form-control">
...
<?php $__env->stopPush(); ?>
<?php endif; ?><?php /**PATH C:\Users\moham\OneDrive\Desktop\Abajim\Abajimnew21052024\Abajimnew\Abajim\resources\views/admin/webinars/create_includes/accordions/file.blade.php ENDPATH**/ ?>