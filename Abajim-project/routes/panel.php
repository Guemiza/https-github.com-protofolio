...
//use App\Http\Controllers\Panel\DashboardControlle;
...
Route::group(['namespace' => 'Panel', 'prefix' => 'panel', 'middleware' => ['check_mobile_app', 'impersonate', 'panel', 'share']], function () {
  //  Route::get('/materialsforlevel', 'DashboardControlle@getMaterialsForLevel');
    Route::get('/generate-pdf', [ManuelScolaireController::class, 'generatePdf'])->name('generate.pdf');
    Route::get('/show-modal', function () {
        return view('showmodal'); // Your blade view with the modal
    });
    Route::get('/modal', function () {
        return view('modal'); // Your blade view with the modal
    });
    ...
    Route::get('/enfant/{id}', 'DashboardController@dashboardEnfant');
    Route::group(['prefix' => 'all-instructor'], function () {
        Route::get('/', 'DashboardController@allinstructor');
    });
   ...
   // Route::get('/getmaterialsforlevel', [DashboardControlle::class, 'getmaterialsforlevel']);
   Route::get('/getmaterialsforlevel', [DashboardController::class, 'getmaterialsforlevel']);
    //Route::get('/getMaterialsForLevel', [DashboardControlle::class, 'DashboardControlle']);
    Route::get('/get/{id}', 'DashboardController@getManuelBySMatiereId');
    Route::post('/enfant/post', 'DashboardController@addEnfant');
    Route::get('/scolaire', [ManuelScolaireController::class, 'index']);
    Route::get('/scolaire/{id}',[ManuelScolaireController::class, 'methode'])->name('show');
    Route::get('/3dpdf',[ManuelScolaireController::class, 'dpdf']);
