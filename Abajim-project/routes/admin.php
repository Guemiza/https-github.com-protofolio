...
Route::group(['prefix' => 'admin', 'namespace' => 'Admin', 'middleware' => 'web'], function () {
    ...
    Route::post('/get-price', 'UserController@getPrice');
    Route::group(['middleware' => 'admin'], function () {
       
        Route::group(['prefix' => 'school'], function () {
            Route::get('/', 'DashboardController@dash');
        });
        ...
        Route::group(['prefix' => 'schools'], function () {
            Route::get('/', 'UserController@schools');
            Route::get('/excel', 'UserController@exportExcelStudents');
        });
       
        Route::group(['prefix' => 'school'], function () {
            Route::get('/kids', 'UserController@kids');
            Route::get('/create/kids', 'UserController@createparent');
            Route::get('/parent/{id}/add/kids', 'UserController@createkids');
            Route::get('/excel', 'UserController@exportExcelStudents');
            Route::post('/kids/{id}/add', 'UserController@addkids');
            Route::post('/kids/{id}/update', 'UserController@updatekids');
        ...
        Route::group(['prefix' => 'users'], function () {
            ...
            Route::post('/storeparent', 'UserController@storeparent');
