...
<nav id="navbar" class="navbar navbar-expand-lg navbar-light">
    <div
        class="{{ (!empty($isPanel) and $isPanel) ? 'container-fluid' : 'container' }}">
        <div class="d-flex align-items-center justify-content-between w-100">
            ...
            <a class="navbar-brand navbar-order d-flex align-items-center justify-content-center mr-0 {{ (empty($navBtnUrl) and empty($navBtnText)) ? 'ml-auto' : '' }}"
                ...
                @if(!empty($generalSettings['logo']))
                    <img src="https://mybucket-abajim.s3.amazonaws.com{{ $generalSettings['logo'] }}"
                            ...
                            <li>
                                <a
                                    ...
                                    <div class="d-flex align-items-center">
                                        <img src="{{ $category->icon }}" class="cat-dropdown-menu-icon mr-10"
                                            alt="{{ $category->title }} icon">
                                        {{ $category->title }}
                                    </div>

                                    <blade
                                        if|(!empty(%24category-%3EsubCategories)%20and%20count(%24category-%3EsubCategories))>
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu user-profile-dropdown" aria-labelledby="dropdownMenuButton">
                            ...
                            <a class="dropdown-item"
                                ...
                                <span
                                    class="font-14 text-dark-blue">{{ trans('public.my_panel') }}</span>
                            </a>
                            ...
                            <a class="dropdown-item" href="/logout">
                                ...
                                <span
                                    class="font-14 text-dark-blue">{{ trans('panel.log_out') }}</span>
                            </a>
                        </div>
                    </div>
                @else
