 ...
 <ul class="nav nav-pills scrollmenu">
     <div class="scrollmenu">
             ...
             @foreach($Manuels as $manuel)
                 <li class="nav-item ">
                     <a class="nav-link {{ $manuel->id ==  $id  ? 'active' : '' }}" href="/panel/scolaire/teacher/{{$manuel->id}}icon=1&page=6">{{$manuel->matiere->section->level->name}} {{$manuel->matiere->section->name}} </a>
                 </li>
             @endforeach
      ...
      <div id="tabsContainer" class="style-scope tp-yt-paper-tabs style-iYFIZ">
        <div id="tabsContent" style-target="content" class="tabs-content scrollable style-scope tp-yt-paper-tabs">
          ...
          <tp-yt-paper-tab slot="tabs" noboldonfocus="" class="style-scope yta-screen" id="overview" role="tab" style-target="host" aria-disabled="false" aria-selected="true" tabindex="0" focused="">
            <div class="tab-content style-scope tp-yt-paper-tab" style-target="tab-content">
              <ytcp-ve track-click="" class=" style-scope yta-screen style-scope yta-screen" role="none">
              <a  href="/panel/scolaire/teacher/{{$id}}?icon=1&page=6">  Dashboard</a>
              </ytcp-ve>
            </div>
            <paper-ripple class="style-scope tp-yt-paper-tab">
...
@endphp
                 ...
                 <br><br>
                       <div class="form-group">
                           ...
                           <input name="titre" type="text" value="{{ old('titre') }}" class="form-control @error('titre') is-invalid @enderror">
                           @error('titre')
                       ...
                       <input type="hidden" placeholder="enter manuel id" name="manuel" value="{{ $parameterValue }}" onclick="this.value=''">
      
      <input type="hidden"  name="numero" value="{{ $icon }}" onclick="this.value=''">
    
      <input type="hidden"  name="page" value="{{ $page }}" onclick="this.value=''">
      <div class="form-group ">
                           <label class="input-label" for="video"> Video:</label>
                          
                               <input type="file" class="form-control @error('video') is-invalid @enderror" name="video"  id="video" class="box">
                           @error('video')
                           <div class="invalid-feedback">
                               {{ $message }}
                           </div>
                       ...
                       <div class="form-group ">
                           <label class="input-label" for="thumbnail">Image video:</label>
                               ...
                               <input type="file"   class="form-control @error('thumbnail') is-invalid @enderror"  name="thumbnail" accept="image/jpeg,image/png">
                           @error('thumbnail')
                           <div class="invalid-feedback">
                               {{ $message }}
                           </div>
