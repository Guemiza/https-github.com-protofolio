    ...
    <section class="section" >
        <div class="row">
            <div class="col-12 mb-4">
              ...
              {{--  @if($authUser->isSchool()) 
                <div class="hero text-white hero-bg-image hero-bg" data-background="">
        ...
        @if($authUser->isSchool())
            <div class="row">
                <div class="col-lg-6 col-md-4 col-sm-12">
                        @if(!empty($getTotalSalesStatisticsSchool))
                            <div class="card card-statistic-2">
                                <div class="card-stats">
                                    ...
                                    <div class="card-stats-items">
                                        <div class="card-stats-item">
                                            <div class="card-stats-item-count">{{ $getTotalSalesStatisticsSchool['todaySales'] }}</div>
                                            <div class="card-stats-item-label">{{trans('admin/main.today')}}</div>
                                        </div>
                                        <div class="card-stats-item">
                                            <div class="card-stats-item-count">{{ $getTotalSalesStatisticsSchool['monthSales'] }}</div>
                                            <div class="card-stats-item-label">{{trans('admin/main.this_month')}}</div>
                                        </div>
                                        <div class="card-stats-item">
                                            <div class="card-stats-item-count">{{ $getTotalSalesStatisticsSchool['yearSales'] }}</div>
                                ...
                                <div class="card-wrap">
                                    ...
                                    <div class="card-body">
                                        {{ $getTotalSalesStatisticsSchool['totalSales'] }}
                                    </div>
                                </div>
                            </div>
                        @endif
                ...
                <div class="col-lg-6 col-md-4 col-sm-12">              
                        @if(!empty($getIncomeStatisticsSchool))
                            <div class="card card-statistic-2">
                                <div class="card-stats">
                                    <div class="card-stats-title">{{trans('admin/main.income_statistics_school')}}</div>

                                    <div class="card-stats-items">
                                        <div class="card-stats-item">
                                            <div class="card-stats-item-count">{{ addCurrencyToPrice($getIncomeStatisticsSchool['todaySales']) }}</div>
                                            <div class="card-stats-item-label">{{trans('admin/main.today')}}</div>
                                        </div>

                                        <div class="card-stats-item">
                                            <div class="card-stats-item-count">{{ addCurrencyToPrice($getIncomeStatisticsSchool['monthSales']) }}</div>
                                            <div class="card-stats-item-label">{{trans('admin/main.this_month')}}</div>
                                        </div>

                                        <div class="card-stats-item">
                                            <div class="card-stats-item-count">{{ addCurrencyToPrice($getIncomeStatisticsSchool['yearSales']) }}</div>
                                            <div class="card-stats-item-label">{{trans('admin/main.this_year')}}</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-wrap">
                                    ...
                                    <div class="card-body">
                                        {{ addCurrencyToPrice($getIncomeStatisticsSchool['totalSales']) }}
                                    </div>
                                </div>
                            </div>
                        @endif
              ...
              <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <a class="card card-statistic-1">
                            ...
                            <div class="card-wrap">
                                <div class="card-header">
                                    <h4>{{trans('admin/main.list_of_participating_children')}}</h4>
                                </div>
                                <div class="card-body">
                                    {{ $getSubscribeCountSchool }}
                                </div>
                            </div>
                        </a>
                    </div>      
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <a href="/admin/comments/webinars" class="card card-statistic-1">
                            ...
                            <div class="card-wrap">
                                <div class="card-header">
                                    <h4>{{trans('admin/main.list_of_not_participating_children')}}</h4>
                                </div>
                                <div class="card-body">
                                    {{ $getNotSubscribeCountSchool }}
                                </div>
                            </div>
                        </a>
                    </div>
           ...
           @if(!$authUser->isSchool())
                    ...
                    <div class="col-lg-8 col-md-12 col-12 col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        @if(!empty($getMonthAndYearSalesChartStatisticsSchool))
                                            <div class="statistic-details mt-4 position-relative">
                                                <div class="statistic-details-item">
                                                    <span class="text-muted">
                                                        @if($getMonthAndYearSalesChartStatisticsSchool['todaySales']['grow_percent']['status'] == 'up')
                                                            <span class="text-primary"><i class="fas fa-caret-up"></i></span>
                                                        @else
                                                            <span class="text-danger"><i class="fas fa-caret-down"></i></span>
                                                        @endif

                                                        {{ $getMonthAndYearSalesChartStatisticsSchool['todaySales']['grow_percent']['percent'] }}
                                                    </span>

                                                    <div class="detail-value">{{ addCurrencyToPrice($getMonthAndYearSalesChartStatisticsSchool['todaySales']['amount']) }}</div>
                                                    <div class="detail-name">{{trans('admin/main.today_sales')}}</div>
                                                </div>
                                                <div class="statistic-details-item">
                                                    <span class="text-muted">
                                                        @if($getMonthAndYearSalesChartStatisticsSchool['weekSales']['grow_percent']['status'] == 'up')
                                                            <span class="text-primary"><i class="fas fa-caret-up"></i></span>
                                                        @else
                                                            <span class="text-danger"><i class="fas fa-caret-down"></i></span>
                                                        @endif

                                                        {{ $getMonthAndYearSalesChartStatisticsSchool['weekSales']['grow_percent']['percent'] }}
                                                    </span>

                                                    <div class="detail-value">{{ addCurrencyToPrice($getMonthAndYearSalesChartStatisticsSchool['weekSales']['amount']) }}</div>
                                                    <div class="detail-name">{{trans('admin/main.week_sales')}}</div>
                                                </div>
                                                <div class="statistic-details-item">
                                                    <span class="text-muted">
                                                        @if($getMonthAndYearSalesChartStatisticsSchool['monthSales']['grow_percent']['status'] == 'up')
                                                            <span class="text-primary"><i class="fas fa-caret-up"></i></span>
                                                        @else
                                                            <span class="text-danger"><i class="fas fa-caret-down"></i></span>
                                                        @endif

                                                        {{ $getMonthAndYearSalesChartStatisticsSchool['monthSales']['grow_percent']['percent'] }}
                                                    </span>

                                                    <div class="detail-value">{{ addCurrencyToPrice($getMonthAndYearSalesChartStatisticsSchool['monthSales']['amount']) }}</div>
                                                    <div class="detail-name">{{trans('admin/main.month_sales')}}</div>
                                                </div>
                                                <div class="statistic-details-item">
                                                    <span class="text-muted">
                                                        @if($getMonthAndYearSalesChartStatisticsSchool['yearSales']['grow_percent']['status'] == 'up')
                                                            <span class="text-primary"><i class="fas fa-caret-up"></i></span>
                                                        @else
                                                            <span class="text-danger"><i class="fas fa-caret-down"></i></span>
                                                        @endif

                                                        {{ $getMonthAndYearSalesChartStatisticsSchool['yearSales']['grow_percent']['percent'] }}
                                                    </span>

                                                    <div class="detail-value">{{ addCurrencyToPrice($getMonthAndYearSalesChartStatisticsSchool['yearSales']['amount']) }}</div>
                                                    <div class="detail-name">{{trans('admin/main.year_sales')}}</div>
                                                </div>
                                            </div>
                                        @endif
            ...
            @if($authUser->isSchool())
             <div class="col-lg-4 col-md-12 col-12 col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4>{{trans('admin/main.classes_statistics_level')}}</h4>
                    </div>
                    <div class="card-body">
