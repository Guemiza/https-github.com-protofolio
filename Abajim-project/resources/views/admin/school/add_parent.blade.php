...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1> {{ trans('admin/main.users_parent') }} {{ !empty($user) ? trans('/admin/main.edit'): trans('admin/main.new') }}</h1>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 col-md-6 col-lg-6">
                                    <form action="/admin/users/storeparent" method="Post">
                                        {{ csrf_field() }}

                                        <div class="form-group">
                                            <label>{{ trans('/admin/main.full_name_parent') }}</label>
                                        ...
                                        <div class="form-group">
                                            <label for="username">{{ trans('admin/main.email_or_mobile') }}:</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                @enderror
                                                    ...
                                                    <input value="3" id="roleId" name="role_id" hidden/>
                                                    <input value="active"  name="status" hidden/>
