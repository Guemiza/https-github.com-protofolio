            ...
            <div class="table-responsive text-center">
                <table class="table table-striped font-14">
                    <tr>
                        ...
                        <th>{{ trans('admin/main.parent') }}</th>
                        <th>{{ trans('admin/main.mobile_parent') }}</th>
                        ...
                        <tr>
                            ...
                            <td class="text-left">
                             ...
                             <?php  $varff = DB::table('users')->where('id', $user->organ_id)->pluck('full_name');
                                ...
                                ?>
                            <td>@if(!empty($varff[0])){{{ $varff[0] }}}@endif</td>
                            <td>@if(!empty($mobile[0])){{{ $mobile[0] }}}@endif</td>

                           <td>@if(!empty($level[0])){{{ $level[0] }}}@endif</td>
                           <td> @if(!empty($package_sales[0]))
                                    <?php                       
                                    $subscribe = DB::table('subscribe_translations')->where('subscribe_id', $package_sales[0])->where('locale', 'ar')->pluck('title');                       
                                    ?>
                                    @if(!empty($subscribe[0])){{{ $subscribe[0] }}}@endif
