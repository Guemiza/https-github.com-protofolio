...
class UserController extends Controller
{
    ...
    {
        // Save the original user's ID in the session
        $originalId = Auth::id();
        ...
        return redirect('/panel/enfant/1'); // Redirect to the dashboard or intended panel
    }
    public function revertImpersonate()
    {
        // Ensure there's an original user ID stored in the session
        if (session()->has('original_user')) {
            ...
            // Remove the impersonation session key
