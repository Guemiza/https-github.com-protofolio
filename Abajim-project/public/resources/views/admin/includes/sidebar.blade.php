    ...
    <aside id="sidebar-wrapper">
       ...
       @endif
        ...
        <ul class="sidebar-menu">
            {{--@if($authUser->isSchool())     school dashboard  
            ...
            @endif
            @if($authUser->isSchool())
               <li class="nav-item {{ (request()->is('admin/school/create/kids*')) ? 'active' : '' }}" >
                    <a href="/admin/school/create/kids" class="nav-link beep beep-sidebar" >
                        <i class="fa fa-user-plus "></i>
                        <span>{{ trans('public.school_kids_add') }}</span>
                    </a>
                </li>
            ...
            @can('admin_users')
             @if($authUser->isSchool())
                        @can('admin_users_list')
                            <li class="{{ (request()->is('admin/school/kids')) ? 'active' : '' }}">  
                                <a class="nav-link" href="/admin/school/kids">
                                    <i class="fa fa-users"></i>
                                    <span>{{ trans('public.school_kids_list') }}</span>
                                </a>
                            </li>
                        @endcan()
             @else            
                    ...
                    <ul class="dropdown-menu">
                        ...
                        @can('admin_users_list')
                            <li class="{{ (request()->is('admin/students')) ? 'active' : '' }}">
                                <a class="nav-link" href="/admin/students">{{ trans('public.school_kids_list') }}</a>
                            </li>
                        @endcan()
                        @endif  
                        ...
                        @can('admin_organizations_list')
                            <li class="{{ (request()->is('admin/organizations')) ? 'active' : '' }}">
                                <a class="nav-link" href="/admin/organizations">{{ trans('public.parent_list') }}</a>
                            </li>
                        @endcan()
                        @if($authUser->isAdmin())
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_supports_list')
                            <li class="{{ (request()->is('admin/supports')) ? 'active' : '' }}">
                                <a class="nav-link" href="/admin/supports">{{ trans('admin/main.tickets') }}</a>
                            </li>
                        @endcan
