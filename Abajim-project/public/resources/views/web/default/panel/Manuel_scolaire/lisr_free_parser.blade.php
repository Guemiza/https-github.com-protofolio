    ...
    <div class="row">
        <div class="col-sm-8">
            ...
            <div style="padding:10px">
                {{-- <a href="https://83fe07fa-trial.flowpaper.com/124dc04df/#PreviewMode=Miniature" class="fp-embed" data-fp-width="1100px" data-fp-height="980px" style="max-width: 100%;max-height: 100%"></a><script async defer src="https://cdn-online.flowpaper.com/zine/3.8.4/js/embed.min.js"></script> --}}
                {{-- <a href="https://83fe07fa-trial.flowpaper.com/124dc04df/" class="fp-embed" data-fp-width="1100px" data-fp-height="950px" style="max-width: 100%"></a><script async defer src="https://cdn-online.flowpaper.com/zine/3.8.4/js/embed.min.js"></script> --}}
                {{-- <a href="https://www.abajim.com/FlowPaper/Publications/-/-.html?reload=1717760810339#page=6"
                ...
                {{-- <object data="{{ asset($pdfPath) }}#toolbar=0&page={{ $page }}&zoom=auto" type="application/pdf" width="100%"
                height="880px">
            ...
            <div>
                ...
                @if (!empty($videostitleAll))
                    <h2 style="margin-top:11px"> <span class="gradient-title"
                            style="padding: 54px!important;text-align: center;background: linear-gradient(to left,#1d3b65,#1d3b65);-webkit-background-clip: text;color: transparent;font-size:32px">{{ $videostitleAll->titleAll }}</span>
                    </h2>
                    <br>
                @endif
                @if ($videos != '[]')
                                                ...
                                                <a class="yt-simple-endpoint style-scope ytd-video-owner-renderer  ml-16"
                                                    ...
                                                    <yt-img-shadow id="avatar" width="40"
                                                        ...
                                                        <img id="img" class="style-scope yt-img-shadow "
                                                            width="40" src="{{ $videos[0]->teachers->avatar }}">
                                                ...
                                                <div id="subscribe-button" style="margin-left:5px"
                                                    ...
                                                    <form action="/panel/add" method="POST">
                                                        ...
                                                        <input id="user_iddteacher" name="trtr"
                                                            value="{{ $videos[0]->teachers->id }}" hidden />
                                                        <button type="submit"
                                                            class="yt-spec-button-shape-next {{ $isSubscribed ? 'yt-spec-button-shape-next--filled yt-spec-button-shape-next--mono yt-spec-button-shape-next--size-m' : 'yt-spec-button-shape-next--filled1 yt-spec-button-shape-next--mono yt-spec-button-shape-next--size-m' }} style-OodnQ ">
                                                            <span
                        ...
                        <div class="webinar-card webinar-list webinar-list-2 d-flex m-30">
                            ...
                            <div class="webinar-card-body w-100 d-flex flex-column">
                                <div class="d-flex align-items-center justify-content-between">
                                    <a
                                        onclick="playInMainPlayer('{{ asset($video->video) }}','{{ $video->titre }}','{{ $video->teachers->full_name }}','{{ $video->user_id }}','{{ $video->teachers->avatar }}')">
                                        {{-- <h4 class="mt-5 webinar-title font-weight-bold font-12 text-dark-blue"
                                        style="white-space: normal;font-size: 0.895rem !important;"> {{ $video->titre }} </h4> --}}
                                    </a>
                                </div>
                                ...
                                {{-- @include('web.default.includes.webinar.rate',['rate' => 4]) --}}
                                ...
                                <!-- <div class="mt-10 d-flex justify-content-between ">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <span class="date-published ml-5 font-6"> {{ $video->created_at }}</span>
                                        </div>
                                    </div>
        ...
        <section>
                ...
                <div class="form-group mt-20">
                    ...
                    <div class="user-search-card text-center d-flex flex-column align-items-center justify-content-center">
                        <div class="user-avatar" style="width:65px;height:57px!important;">
                            <img src="/store/870/avatar/617a4f7c09d61.png" class="img-cover rounded-circle"
                                style="width:60px;height:60px!important;">
                        </div>
                        <a href="">

                            <span class="d-block font-12 text-gray mt-5">Jessica Wray</span>
                        </a>
                    </div>
                    <br>
                    ...
                    <div class="user-search-card text-center d-flex flex-column align-items-center justify-content-center">
                        <div class="user-avatar" style="width:65px;height:57px!important;">
                            <img src="/store/1015/avatar/6417573dd820b.png" class="img-cover rounded-circle"
                                style="width:60px;height:60px!important;">
                        </div>
                        <a href="">
                            <span class="d-block font-12 text-gray mt-5">Mohamed romdhane</span>
                        </a>
                    </div>
                    ...
                    <div class="user-search-card text-center d-flex flex-column align-items-center justify-content-center">
                        <div class="user-avatar" style="width:65px;height:57px!important;">
                            <img src="/store/929/avatar/617a4f5d834c8.png" class="img-cover rounded-circle"
                                style="width:60px;height:60px!important;">
                        </div>
                        <a href="">
                            <span class="d-block font-12 text-gray mt-5">Kate Willi</span>
                        </a>
                    </div>
                </div>
            ...
            <div class="mt-20 p-20 rounded-sm shadow-lg border border-gray300 filters-container">
                ...
                <div class="form-group mt-20">
                    <br>
                    <img src="/assets/default/img/iconres.jpg" class="img-cover rounded-circle"
                        style="width:60px;margin-left:10px;height:60px!important;">
                    <br> <br>
                    <img src="/assets/default/img/noteicontake.jpg" class="img-cover rounded-circle"
                        style="width:60px;margin-left:10px;height:60px!important;">
                    <br> <br>
                    <img src="/assets/default/img/iconvoice.jpg" class="img-cover rounded-circle"
                        style="width:60px;margin-left:10px;height:60px!important;">
                </div>
            </div>
