...
!(function(e) {
    ...
    function o() {
        (fromTimepicker = e(".from-clockpicker").clockpicker({
            ...
            afterDone: function() {
                ...
                var o = e(".from-clockpicker input"),
    ...
    n(),
        e("body").on("change", "#timeTwelveSwitch", function(t) {
            ...
            var n = "AM",
                o = "PM";
            this.checked && ((n = "PM"), (o = "AM"));
            var i = e(".from-time.pulsate").find(".js-am-pm"),
                r = e(".to-time.pulsate").find(".js-am-pm");
            if (i.length) {
                i.text(n);
                var a = e(".from-clockpicker input"),
                    l = a.val();
                (l = l.replace(o, n)), a.val(l);
            }
            if (r.length) {
                r.text(n);
                var c = e(".to-clockpicker input"),
                    s = c.val();
                (s = s.replace(o, n)), c.val(s);
            }
        }),
        e("body").on("click", ".add-time", function(t) {
            ...
            var n =
                ...
                e(this)
                    .closest("tr")
                    .attr("data-day") +
                '" id="saveTime" class="btn btn-sm btn-primary">' +
                saveLang +
                '</button>\n    <button type="button" class="btn btn-sm btn-danger ml-10 close-swl">' +
                closeLang +
                "</button>\n</div>";
        ...
        e("body").on("click", "#saveTime", function(t) {
            ...
            var a = { day: r, time: o + "-" + i };
            e.post("/panel/meetings/saveTime", a, function(e) {
                e &&
                    200 == e.code &&
                    (Swal.fire({
        ...
        e("body").on("click", ".remove-time", function(t) {
            t.preventDefault(), i(e(this).attr("data-time-id"));
        }),
        e("body").on("click", "#deleteTime", function(t) {
            t.preventDefault();
            var n = e(this).attr("data-time-id");
            (function(t) {
                var n = { time_id: t };
        ...
        e("body").on("change", "#temporaryDisableMeetingsSwitch", function(t) {
            ...
            e.post("/panel/meetings/temporaryDisableMeetings", i, function(e) {
                ...
                Swal.fire({ text: requestFailed, icon: "error" }),
