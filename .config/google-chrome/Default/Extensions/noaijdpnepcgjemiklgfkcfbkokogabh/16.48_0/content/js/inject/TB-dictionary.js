		...
		for(j = 0; j < T2.length; j++){
			...
			if(R[1] != undefined){
				...
				for(k = 0; k < R2.length; k++){
					...
					if(k < (R2.length-1))	Rline = Rline + "<a class=_ALNK href='TB-dictionary.html?dir="+ F + "|" + T +"&text=" + encodeURIComponent(tmpLNK) + "'>" + R2[k] + "</a>, ";
					else			Rline = Rline + "<a class=_ALNK href='TB-dictionary.html?dir="+ F + "|" + T +"&text=" + encodeURIComponent(tmpLNK) + "'>" + R2[k] + "</a>";
				}
