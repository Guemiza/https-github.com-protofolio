...
(function(){GEBI("SRV12").addEventListener("keyup",function(){ if(GEBI("SRV12").value=="" || GEBI("SRV12").value==" ")GEBI('SRV12').value=FExtension.store.get("SL_HK_SO_wpt");},!1); } )();
/*
(function(){GEBI("SRV13").addEventListener("click",function(){ SL_ACTIVE = GEBI("SRV13"); SL_TMP=SL_ACTIVE.value; SL_ACTIVE.focus();SL_ACTIVE.select();SL_KBD(1);},!1); } )();
(function(){GEBI("SRV13").addEventListener("mouseout",function(){ SL_KBD(0);},!1); } )();
(function(){GEBI("SRV13").addEventListener("keyup",function(){ if(GEBI("SRV13").value=="" || GEBI("SRV13").value==" ")GEBI('SRV13').value=FExtension.store.get("SL_HK_CT_wpt");},!1); } )();
*/
...
(function(){GEBI("SL_HK12").addEventListener("click",function(){ SL_HIDE_HK("SL_HK12","SL_HIDE12");VERIFY();},!1); } )();
(function(){GEBI("SL_HK13").addEventListener("click",function(){ SL_HIDE_HK("SL_HK13","SL_HIDE13");VERIFY();},!1); } )();
...
function VERIFY(ob){
 ...
 var ARR = new Array(4);
 ARR[0] = GEBI("SRV6").value;
 ARR[1] = GEBI("SRV7").value;
 ARR[2] = GEBI("SRV12").value;
 ARR[3] = GEBI("SRV13").value;
 GEBI("SRV6").style.background='#FFF';
 GEBI("SRV7").style.background='#FFF';
 GEBI("SRV12").style.background='#FFF';
 GEBI("SRV13").style.background='#FFF';

 if(ARR[0]==ARR[1]){GEBI("SRV6").style.background='#F0D3D1'; GEBI("SRV7").style.background='#F0D3D1';}
 if(ARR[0]==ARR[2]){GEBI("SRV6").style.background='#F0D3D1'; GEBI("SRV12").style.background='#F0D3D1';}
 if(ARR[0]==ARR[3]){GEBI("SRV6").style.background='#F0D3D1'; GEBI("SRV13").style.background='#F0D3D1';}
 if(ARR[1]==ARR[2]){GEBI("SRV7").style.background='#F0D3D1'; GEBI("SRV12").style.background='#F0D3D1';}
 if(ARR[1]==ARR[3]){GEBI("SRV7").style.background='#F0D3D1'; GEBI("SRV13").style.background='#F0D3D1';}
 if(ARR[2]==ARR[3]){GEBI("SRV12").style.background='#F0D3D1'; GEBI("SRV13").style.background='#F0D3D1';}
