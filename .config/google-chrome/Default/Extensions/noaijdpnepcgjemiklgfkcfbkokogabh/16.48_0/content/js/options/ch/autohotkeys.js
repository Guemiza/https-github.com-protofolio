...
(function(){GEBI("SRV12").addEventListener("click",function(){ SL_ACTIVE = GEBI("SRV12"); SL_TMP=SL_ACTIVE.value; SL_ACTIVE.focus();SL_ACTIVE.select();},!1); } )();
(function(){GEBI("SRV12").addEventListener("mouseout",function(){NoneColor(12);},!1); } )();
(function(){GEBI("SRV12").addEventListener("keyup",function(){NoBlank(12);},!1); } )();

//(function(){GEBI("SRV13").addEventListener("click",function(){ SL_ACTIVE = GEBI("SRV13"); SL_TMP=SL_ACTIVE.value; SL_ACTIVE.focus();SL_ACTIVE.select();},!1); } )();
//(function(){GEBI("SRV13").addEventListener("mouseout",function(){NoneColor(13);},!1); } )();
//(function(){GEBI("SRV13").addEventListener("keyup",function(){NoBlank(13);},!1); } )();
...
(function(){
	GEBI("SRV12").addEventListener("mousedown",function(){
 	GEBI("SL_kbd").style.display="none";	},!1);
})();


(function(){
	GEBI("SRV13").addEventListener("mousedown",function(){
 	GEBI("SL_kbd").style.display="none";	},!1);
})();
...
(function(){
	GEBI("SRV12").addEventListener("keyup",function(){
	 DefaultText();
	 setTimeout(function() {Resolve_the_HK_conflicts();}, 1800);
	},!1);
})();
...
(function(){
	GEBI("SRV13").addEventListener("keyup",function(){
	 DefaultText();
	 setTimeout(function() {Resolve_the_HK_conflicts();}, 1800);
	},!1);
})();
...
function CONSTRUCTOR(){
  ...
  GEBI('SL_tar').appendChild(document.createTextNode(FExtension.element(FExtension.store.get("SL_LOCALIZATION"),'extSeTa')));
...
function INIT(){
  ...
  if(line.length>1) SL_ACTIVE_TAB = line[1];
	...
	if(SL_ACTIVE_TAB==0 || SL_ACTIVE_TAB==1 || SL_ACTIVE_TAB == 2){
	  ...
	  if(window['parent'].GEBI("SL_FK_box11").checked==true){
	  ...
	  GEBI('SRV10').value=window['parent'].GEBI('SRV11').value;
	  GEBI('SRV12').value=FExtension.store.get("SL_HK_SO_wpt");
	  GEBI('SRV13').value=FExtension.store.get("SL_HK_CT_wpt");
        } else {
	  ...
	  GEBI("SRV5").value=FExtension.store.get("SL_HK_bb1");
        ...
        if(SL_ACTIVE_TAB==6 || SL_ACTIVE_TAB == 7 || SL_ACTIVE_TAB == 12 || SL_ACTIVE_TAB == 13){
	  ...
	  if(window['parent'].GEBI("SL_HK12").checked==true){
	  ...
	  if(window['parent'].GEBI("SL_HK13").checked==true){
	  ...
	  GEBI('SRV12').value=window['parent'].GEBI('SRV12').value;
	  GEBI('SRV13').value=window['parent'].GEBI('SRV13').value;
	  GEBI("SRV10").value=FExtension.store.get("SL_change_lang_HK_it")
        } else {
 ...
 if(UNBLOCK == 0) {
  ...
  if (result==0){
	  GEBI("HK_conflicts_msg").innerText="";
		...
		if(GEBI("IMT_HK10").checked==false) window['parent'].GEBI("SL_HIDE11").style.display="block";
		else window['parent'].GEBI("SL_HIDE11").style.display="none";

	        window['parent'].GEBI('SRV3').style.background="#fff";
	        window['parent'].GEBI('SRV4').style.background="#fff";
	        window['parent'].GEBI('SRV11').style.background="#fff";
		...
		if(GEBI("IMT_HK5").checked==false) window['parent'].GEBI("SL_HIDE5").style.display="block";
	        ...
	        window['parent'].GEBI('SRV6').value=GEBI('SRV11').value;
		window['parent'].GEBI("SL_translation_mos_bbl2").checked=GEBI("IMT_HK12").checked;
		if(GEBI("IMT_HK11").checked==false) window['parent'].GEBI("SL_HIDE6").style.display="block";
         ...
         if(SL_ACTIVE_TAB==6 || SL_ACTIVE_TAB == 7 || SL_ACTIVE_TAB == 12 || SL_ACTIVE_TAB == 13){
	        ...
	        window['parent'].GEBI('SRV12').value=GEBI('SRV12').value;
	        window['parent'].GEBI('SRV13').value=GEBI('SRV13').value;
		window['parent'].GEBI("SL_HK6").checked=GEBI("IMT_HK6").checked;
		window['parent'].GEBI("SL_HK7").checked=GEBI("IMT_HK7").checked;
		window['parent'].GEBI("SL_HK12").checked=GEBI("IMT_HK12").checked;
		window['parent'].GEBI("SL_HK13").checked=GEBI("IMT_HK13").checked;
		...
		if(GEBI("IMT_HK12").checked==false) window['parent'].GEBI("SL_HIDE12").style.display="block";
		else window['parent'].GEBI("SL_HIDE12").style.display="none";
		if(GEBI("IMT_HK13").checked==false) window['parent'].GEBI("SL_HIDE13").style.display="block";
		else window['parent'].GEBI("SL_HIDE13").style.display="none";

	        window['parent'].GEBI('SRV6').style.background="#fff";
	        window['parent'].GEBI('SRV7').style.background="#fff";
	        window['parent'].GEBI('SRV12').style.background="#fff";
	        window['parent'].GEBI('SRV13').style.background="#fff";
         }
...
function Resolve_the_HK_conflicts__(){
  UNBLOCK = 1;
  var response=0, response2=0, REZ ="";
  var HK = new Array(12);
  for(var j=0; j<HK.length; j++){
	 GEBI("SL_HK_TR"+(j+1)).className="SLTR";
  }
  HK[0] = GEBI("SRV1").value;
  HK[1] = GEBI("SRV2").value;
  HK[2] = GEBI("SRV3").value;
  ...
  HK[8] = GEBI("SRV9").value;
  HK[9] = GEBI("SRV10").value;
  HK[10] = GEBI("SRV12").value;
  HK[11] = GEBI("SRV13").value;
...
function INIT_AUTO_HK(st){
        ...
        box[9]=FExtension.store.get('SL_change_lang_HK_it');
        box[10]=FExtension.store.get('SL_SO_wpt');
        var cnt=0;
...
function VERIFY_ALL_TABS(st){
	...
	if(box[7]==box[8] || box[7]==box[9] || box[8]==box[9]) cnt++;
