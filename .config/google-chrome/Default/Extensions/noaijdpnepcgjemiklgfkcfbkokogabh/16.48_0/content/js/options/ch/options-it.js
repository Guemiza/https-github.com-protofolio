...
(function(){GEBI("SRV11").addEventListener("click",function(){ SL_ACTIVE = GEBI("SRV11"); SL_TMP=SL_ACTIVE.value; SL_ACTIVE.focus();SL_ACTIVE.select();SL_KBD(1);},!1); } )();
(function(){GEBI("SRV11").addEventListener("mouseout",function(){ SL_KBD(0);},!1); } )();
(function(){GEBI("SRV11").addEventListener("keyup",function(){ if(GEBI("SRV11").value=="")GEBI('SRV11').value=FExtension.store.get("SL_change_lang_HK_it");},!1); } )();
...
(function(){GEBI("SL_FK_box11").addEventListener("click",function(){ SL_HIDE_HK("SL_FK_box11","SL_HIDE11");VERIFY();},!1); } )();
...
function VERIFY(ob){
 ...
 if(GEBI("SRV11").value==""){
	GEBI('SRV11').value=FExtension.store.get("SL_HK_it11");
	GEBI('SL_kbd').innerText = FExtension.element(FExtension.store.get("SL_LOCALIZATION"),'extUseHK');
 }	

 var ARR = new Array(3);
 ARR[0] = GEBI("SRV3").value;
 ARR[1] = GEBI("SRV4").value;
 ARR[2] = GEBI("SRV11").value;
 GEBI("SRV3").style.background='#FFF';
 GEBI("SRV4").style.background='#FFF';
 GEBI("SRV11").style.background='#FFF';
 if(ARR[0]==ARR[1]){GEBI("SRV3").style.background='#F0D3D1'; GEBI("SRV4").style.background='#F0D3D1';}
 if(ARR[1]==ARR[2]){GEBI("SRV4").style.background='#F0D3D1'; GEBI("SRV11").style.background='#F0D3D1';}
 if(ARR[0]==ARR[2]){GEBI("SRV3").style.background='#F0D3D1'; GEBI("SRV11").style.background='#F0D3D1';}
