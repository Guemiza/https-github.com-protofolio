...
//(function(){GEBI("MoveBBLX").addEventListener("keyup",function(){Coord(this);},!1);} )();
//(function(){GEBI("MoveBBLY").addEventListener("keyup",function(){Coord(this);},!1);} )();
...
//(function(){GEBI("MoveBBLX").addEventListener("click",function(){if(this.value==0)this.value="";},!1);} )();
//(function(){GEBI("MoveBBLY").addEventListener("click",function(){if(this.value==0)this.value="";},!1);} )();
//(function(){GEBI("MoveBBLX").addEventListener("mouseout",function(){ReSettler(this);},!1);} )();
//(function(){GEBI("MoveBBLY").addEventListener("mouseout",function(){ReSettler(this);},!1);} )();
...
/*
  var MoveBBL_X = FExtension.store.get("MoveBBLX");
  GEBI("MoveBBLX").value=MoveBBL_X;

  var MoveBBL_Y = FExtension.store.get("MoveBBLY");
  GEBI("MoveBBLY").value=MoveBBL_Y;
*/
...
/*
   if(GEBI("MoveBBLX").value!="-" && GEBI("MoveBBLX").value!="") FExtension.store.set("MoveBBLX",GEBI("MoveBBLX").value);
   else {
	FExtension.store.set("MoveBBLX",0);
	GEBI("MoveBBLX").value=0;
   }	

   if(GEBI("MoveBBLY").value!="-" && GEBI("MoveBBLY").value!="") FExtension.store.set("MoveBBLY",GEBI("MoveBBLY").value);
   else {
	FExtension.store.set("MoveBBLY",0);
	GEBI("MoveBBLY").value=0;
   }	
*/
