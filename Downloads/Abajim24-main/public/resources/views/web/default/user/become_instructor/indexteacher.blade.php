                ...
                <div class="login-card">
                    ...
                    <form method="Post" action="/become-instructor" class="mt-35">
                        ...
                        <div class="form-group">
                            <label class="js-instructor-label font-weight-500 text-dark-blue {{ !$isInstructorRole ? 'd-none' : '' }}">level</label>
                        ...
                        @foreach($level as $level)
                                   ...
                                   <div class="checkbox-button mr-15 mt-10 font-14">
                                       <input type="checkbox" name="occupationsll[]" id="checkbox{{ $level->id }}" value="{{ $level->id }}" @if(!empty($occupationsll) and in_array($level->id,$occupationsll)) checked="checked" @endif>
