...
<div class="row">
    ...
    <div class="col-lg-6">
        ...
        <div style="margin-top:15px">
            ...
            <video id="mainVideoPlayer" width="620" height="440" controls></video>
            ...
            <div class="col-sm-4">
                <a class="X5OiLe vGvPJe" href="#VIDEOOPENID">
                    <div class="WM9LLd" style="margin-top:10px">
                        <div>
                            <video width="160" height="155" poster="{{asset($video->thumbnail)}}" onclick="playInMainPlayer('{{ asset($video->video) }}','{{ $video->titre }}','{{ $video->teachers->full_name }}')">
