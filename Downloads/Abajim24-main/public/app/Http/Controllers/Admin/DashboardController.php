...
class DashboardController extends Controller
{
    ...
    {
       // dd($this->authorize('admin_general_dashboard_show'));
    ...
    {
        $getIncomeStatisticsSchool = $this->getIncomeStatisticsSchool();
        $getTotalSalesStatisticsSchool = $this->getTotalSalesStatisticsSchool();
        $getNewSalesCountSchool = $this->getNewSalesCountSchool();
        $getNotSubscribeCountSchool = $this->getNotSubscribeCountSchool();
        $getSubscribeCountSchool = $this->getSubscribeCountSchool();
        //$getPendingReviewCount = $this->getPendingReviewCount();
        $getMonthAndYearSalesChartSchool = $this->getMonthAndYearSalesChartSchool();
        $getMonthAndYearSalesChartStatisticsSchool = $this->getMonthAndYearSalesChartStatisticsSchool();
        ...
        $data = [
            ...
            'dailySalesTypeStatistics' => $dailySalesTypeStatistics ?? null,
            'getIncomeStatistics' => $getIncomeStatistics ?? null,
            'getIncomeStatisticsSchool' => $getIncomeStatisticsSchool ?? null,
            'getTotalSalesStatistics' => $getTotalSalesStatistics ?? null,
            'getTotalSalesStatisticsSchool' => $getTotalSalesStatisticsSchool ?? null,
            'getNewSalesCount' => $getNewSalesCount ?? 0,
            'getNewSalesCountSchool' => $getNewSalesCountSchool ?? 0,
            'getNewCommentsCount' => $getNewCommentsCount ?? 0,
            'getNewTicketsCount' => $getNewTicketsCount ?? 0,
            'getPendingReviewCount' => $getPendingReviewCount ?? 0,
            'getNotSubscribeCountSchool' => $getNotSubscribeCountSchool ?? 0,
            'getSubscribeCountSchool' => $getSubscribeCountSchool ?? 0,
            'getMonthAndYearSalesChart' => $getMonthAndYearSalesChart ?? null,
            'getMonthAndYearSalesChartSchool' => $getMonthAndYearSalesChartSchool ?? null,
            'getMonthAndYearSalesChartStatistics' => $getMonthAndYearSalesChartStatistics ?? null,
            'getMonthAndYearSalesChartStatisticsSchool' => $getMonthAndYearSalesChartStatisticsSchool ?? null,
            'recentComments' => $recentComments ?? null,
            'recentTickets' => $recentTickets ?? null,
            'recentWebinars' => $recentWebinars ?? null,
            'recentCourses' => $recentCourses ?? null,
